...
select last_insert_id() from PRODUTO; 
select * from PRODUTO; 
...
insert into produto values( 8 , 'NOTEBOOK', 4, '123131' , '1251.29'  ,'A' );
insert into produto values( 9 ,  'SMARTPHONE', 5, '123223', '1242.21'  ,'A');
insert into produto values( 10,  'DESKTOP',4, '1231' ,'1241.21'  ,'A');
insert into produto values( 11,  'TELEVISÃO',5, '142123' ,'2564.92'  ,'A');
insert into produto values( 12,  'DRONE', 4,'7684' ,'2325.32'  ,'A');
