...
public class ConexaoMysql {
    ...
    private static final String DATABASE_URL = "jdbc:mysql://localhost:3306/demo?useTimezone=true&serverTimezone=UTC";
    ...
    //metodo para nao deixar inserir coisas incorretas no banco
