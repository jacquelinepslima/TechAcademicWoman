...
public class ClasseFormatacao {
    public static void main(String[] args) {
        ...
        String nome = "Natasha Busnardo";
        int idade = 21; // idade mental
        double renda = 102.50;
        ...
        System.out.printf("Oi, meu nome é %s, tenho %d anos, não sou obrigada a nada e ganho milhões mas não conto pra ninguém !"
                , nome, idade);
